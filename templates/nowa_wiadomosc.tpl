...
<td width="1000" valign="top" class="pad1 bor2">
	<form enctype='multipart/form-data' action='{$DIR}?strona={$NOWA_WIADOMOSC}' method='POST' name="form1">
	...
	{if $note=="ok"}
	<tr>
		<td colspan="3" align="left" class="bg3 pad4">
	...
	<tr>
		<td colspan="3" align="left" class="bg3 tyt1 pad4 border3">
			<span style="font-family: Verdana; font-size: 9px"><a href="{$DIR}?strona={$NOWA_WIADOMOSC}" style="font-family: Verdana; font-size: 10px; font-weight: bold">Cała grupa</a> - <a href="{$DIR}?strona={$NOWA_WIADOMOSC1}" style="font-family: Verdana; font-size: 9px">Wybrane adresy e-mail</a>
		</td>
	</tr>
	<tr>
		<td colspan="3" align="left" class="bg3 tyt1 pad4 border3">
	...
	<tr>
		<td colspan="3" align="left" class="bg3 tyt1 pad4 border3">
			<span style="font-family: Verdana; font-size: 9px">Do której grupy
		</td>
	</tr>
	<tr>
		<td colspan="3" align="left" class="bg3 tyt1 pad4 border3">
