...
<td width="1000" valign="top" class="pad1 bor2">
	<form enctype='multipart/form-data' action='{$DIR}?strona={$BIULETYN}' method='post'>
	...
	<tr>
		<td colspan="3" align="left" class="bg3 tyt1 pad4 border3">
			<span style="font-family: Verdana; font-size: 9px"><a href="{$DIR}?strona={$BIULETYN}" style="font-family: Verdana; font-size: 10px; font-weight: bold">Cała grupa</a> - <a href="{$DIR}?strona={$BIULETYN1}" style="font-family: Verdana; font-size: 9px">Wybrane adresy e-mail</a>
		</td>
	</tr>
	<tr>
		<td colspan="3" align="left" class="bg3 tyt1 pad4 border3">
